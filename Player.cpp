...
Player::Player(void)
{
	...
	shape.setPoint(2, sf::Vector2f(40, 40));
	shape.setPoint(3, sf::Vector2f(50, 40));
	shape.setPoint(4, sf::Vector2f(50, 35));
	shape.setPoint(5, sf::Vector2f(50, 40));
	shape.setPoint(6, sf::Vector2f(40, 35));
	shape.setPoint(7, sf::Vector2f(30, 20));
	shape.setPoint(8, sf::Vector2f(20, 35));
	shape.setPoint(9, sf::Vector2f(10, 40));
	shape.setPoint(10, sf::Vector2f(10, 35));
	shape.setPoint(11, sf::Vector2f(10, 40));
	shape.setPoint(12, sf::Vector2f(20, 40));
	shape.setPoint(13, sf::Vector2f(20, 60));


	shape.setOrigin(30,40);
	shape.setPosition(1280/2,620);
